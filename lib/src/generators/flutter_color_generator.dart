...
class FlutterColorGenerator implements CodeGenerator {
  ...
  String _generateTokenName(String path) {
    ...
    if (parts.isEmpty) return 'defaultColor';
  ...
  String _generateThemeTokenName(String path, String theme) {
    ...
    if (parts.isEmpty) return '${theme}DefaultColor';

    // Convert to camelCase with theme prefix
    final camelCaseName = theme.toLowerCase() +
        parts.map((part) => _capitalize(part.toLowerCase())).join('');
